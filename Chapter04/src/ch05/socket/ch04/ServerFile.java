...
public class ServerFile {
	...
	public ServerFile() {
		...
		try {
			...
			MsgWriter = new BufferedWriter(new FileWriter(new File("totalMsg.txt")));
			// 쓰레드 처리
	...
	private void memorizeMsg() {
		System.out.println("저장되었습니다.");
		try {
			MsgWriter.write(totalMsg.toString());
			MsgWriter.flush();
			MsgWriter.close();
		} catch (IOException e) {
			// TODO Auto-generated catch block

...
public class HttpMainTest4 {
	...
	public static void main(String[] args) {
		...
		// http 통신을 위한 준비물 1
		try {
			URL url = new URL("https://jsonplaceholder.typicode.com/todos/"); // http 통신을 위한 주소값
			// 준비물 2
			...
			Gson gson = new Gson();
			Type postType = new TypeToken<ArrayList<Todoz>>() {}.getType();
			ArrayList<Todoz> posts = gson.fromJson(str, postType);

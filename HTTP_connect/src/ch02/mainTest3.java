...
public class mainTest3 {
	public static void main(String[] args) {
		try {
			...
			MovieData mData = gson.fromJson(reciveData, MovieData.class);
			System.out.println(mData);
			Type movieDataType = new TypeToken<ArrayList<MovieData>>() {}.getType();
			ArrayList<MovieData> movieDatas = gson.fromJson(reciveData, movieDataType);
